...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-10 items-center justify-center rounded-md bg-inherit transition-colors hover:bg-[#7A8588] p-2 text-sm ring-offset-[#7A8588] data-[placeholder]:text-muted-foreground focus:bg-[#7A8588] focus:outline-none focus:ring-0 focus:ring-ring focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}>
    {children}
